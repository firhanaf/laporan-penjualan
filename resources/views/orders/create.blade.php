    ...
    <div class="bg-light shadow-sm p-4 rounded">
        ...
        <form action="{{ route('orders.store') }}" method="POST" id="order-form">
            ...
            <div class="form-group">
                ...
                <input type="number" name="capital" id="capital" class="form-control" required min="1" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="total_capital" id="total_capital" class="form-control" readonly>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        productDropdown.addEventListener('change', function () {
            ...
            const productName = selectedOption.getAttribute('data-name');
             ...
             console.log("Capital dari produk:", capital);
        ...
        // Event: Quantity or Price Changed
