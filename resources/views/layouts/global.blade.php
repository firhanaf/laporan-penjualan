...
<head>
  ...
  <title>Floweys Project @yield("title")</title>
    ...
    <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
      <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
        ...
        <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
          ...
          <li><a href="{{ route('dashboard') }}"><span class="oi oi-dashboard"></span> Dashboard</a></li>
          <li><a href="{{ route('orders.index') }}"><span class="oi oi-cart"></span> Order</a></li>
          <li><a href="{{ route('products.index') }}"><span class="oi oi-box"></span> Product</a></li>
